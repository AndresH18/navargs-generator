...
internal static class Constants
{
    ...
    internal const string GenerationModeName = "GenerationMode";
    ...
    internal const string GenerationModeFullName = $"{Namespace}.{GenerationModeName}";
    ...
    internal const string GenerationModeSourceCode =
        $$"""
          // <auto-generated/>
          namespace {{Namespace}};

          public enum {{GenerationModeName}}
          {
              Strict,
              Flexible
          }
